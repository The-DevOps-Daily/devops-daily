                    ...
                    >
                      <Link href={`/news/${digest.slug}`} className="block">
                        <div className="grid gap-0 lg:grid-cols-5">
                          {/* Image */}
                          <div className="relative aspect-[40/21] overflow-hidden border-b border-border bg-muted/20 lg:col-span-2 lg:aspect-auto lg:border-r lg:border-b-0">
                            <Image
                          ...
                          {/* Content */}
                          <div className="p-5 md:p-6 lg:col-span-3">
                            {/* Meta */}
