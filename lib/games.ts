...
const games: Game[] = [
  ...
  },
  {
    ...
    href: '/games/webhook-delivery-simulator',
    tags: [
      'webhooks',
      'http',
      'retries',
  ...
  {
    id: 'bounce-triage-simulator',
    type: 'simulator',
    title: 'Bounce Triage Simulator',
    seoTitle: 'SMTP Bounce Triage Simulator: Hard, Soft, Blocked or Complaint?',
    description:
    ...
    href: '/games/bounce-triage-simulator',
    tags: [
      'smtp',
      'email',
      'bounces',
  ...
  {
    id: 'binary-byte-simulator',
    type: 'simulator',
    title: 'Binary Byte Simulator',
    seoTitle: 'Binary Simulator: Flip Bits, Read Decimal, chmod and Subnet Masks',
    description:
    ...
    href: '/games/binary-byte-simulator',
    tags: [
      'binary',
      'bits',
      'chmod',
  ...
  {
    id: 'k8s-rbac-simulator',
    type: 'simulator',
    title: 'Kubernetes RBAC Simulator',
    seoTitle: 'Kubernetes RBAC Simulator: Why Can This Service Account Not List Pods',
    description:
  ...
  {
    id: 'cron-expression-simulator',
    type: 'simulator',
    title: 'Cron Expression Simulator',
    seoTitle: 'Cron Expression Simulator: See Exactly When Your Job Fires',
    description:
    ...
    badgeText: 'New',
    color: 'from-sky-500 to-indigo-600',
    href: '/games/cron-expression-simulator',
    tags: [
      'cron',
      'linux',
      'scheduling',
  ...
  {
    id: 'yaml-parsing-simulator',
    type: 'simulator',
    title: 'YAML Parsing Simulator',
    seoTitle: 'YAML Parsing Simulator: Why country: NO Becomes false',
    description:
    ...
    href: '/games/yaml-parsing-simulator',
    tags: [
      'yaml',
      'configuration',
      'kubernetes',
  ...
  {
    id: 'git-merge-conflict-simulator',
    type: 'simulator',
    title: 'Git Merge Conflict Simulator',
    seoTitle: 'Git Merge Conflict Simulator: Resolve Conflicts, --ours/--theirs, Rebase and Abort',
    description:
    ...
    href: '/games/git-merge-conflict-simulator',
    tags: [
      'git',
      'merge-conflict',
      'version-control',
  ...
  },
  {
    ...
    seoTitle: 'Container Escape Simulator: Spot the Docker Flag That Owns the Host',
    description:
    ...
    href: '/games/docker-escape',
    tags: ['security', 'docker', 'containers', 'escape', 'privileged', 'capabilities', 'hardening', 'interactive'],
    isNew: true,
    category: 'Security',
