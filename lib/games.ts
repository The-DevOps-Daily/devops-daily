...
const games: Game[] = [
  ...
  },
  {
    ...
    type: 'simulator',
    title: 'Terraform Terminal Simulator',
    seoTitle: 'Terraform Terminal Simulator: Practice init, plan, and apply in the Browser',
    description:
      'Practice the Terraform workflow in an interactive browser lab. Read the HCL config next to the terminal, run init, validate, plan, apply, and destroy against a safe in-browser AWS example, and watch state update live.',
    iconName: 'Cloud',
    badgeText: 'New',
