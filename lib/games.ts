...
const games: Game[] = [
  ...
  {
    id: 'cloud-region-failure-simulator',
    type: 'simulator',
    title: '3D Cloud Region Failure Simulator',
    seoTitle: '3D Cloud Region Failure Simulator: Visualize Multi-AZ Outages and Failover',
    description:
      'Explore a multi-AZ cloud region in 3D with an interactive simulator. Trigger availability zone outages, database failover, retry storms, queue backlogs, and cache failures while watching traffic, blast radius, latency, availability, and cost change in real time.',
    iconName: 'Cloud',
    badgeText: 'New',
    color: 'from-primary to-sky-600',
    href: '/games/cloud-region-failure-simulator',
    tags: [
      'cloud',
      'threejs',
      '3d',
