...
const games: Game[] = [
  ...
  },
  {
    ...
    description:
      'Visualize Kubernetes networking and CNI packet paths with an interactive simulator. Learn Pod-to-Pod routing, same-node and cross-node traffic, ClusterIP Services, kube-proxy, eBPF service routing, Ingress, NetworkPolicy, and internet egress.',
    iconName: 'Network',
    badgeText: 'New',
