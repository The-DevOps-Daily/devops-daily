  ...
  useEffect(() => {
    ...
    h2Elements.forEach((h2) => {
      ...
      sectionWrapper.className =
        'news-section-box mb-8 p-8 border rounded-lg bg-card hover:border-primary/30 transition-all';
    ...
    h3Elements.forEach((h3) => {
      ...
      itemWrapper.className =
        'news-item-box mb-6 last:mb-0 p-6 border rounded-md bg-muted/30 hover:bg-muted/50 hover:border-primary/20 transition-all';
