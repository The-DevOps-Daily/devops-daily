  ...
  const logo = (
    <div className={cn('flex items-center group', className)}>
      <svg
        ...
        width={size}
        height={size}
        className="text-primary transition-all duration-500 ease-out group-hover:scale-110 group-hover:rotate-3 group-hover:drop-shadow-lg"
        fill="currentColor"
      >
        <defs>
        ...
        <g
          className="group-hover:fill-[url(#logo-gradient-hover)] transition-all duration-500"
          fill="currentColor"
          stroke="none"
      ...
      {showText && (
        <span className={cn(
          'ml-2 text-xl font-bold transition-all duration-500 group-hover:text-primary',
          textClassName
        )}>
          DevOps Daily
        </span>
