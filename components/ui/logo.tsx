  ...
  const logo = (
    <div className={cn('flex items-center group', className)}>
      ...
      >
        ...
        >
          <path 
            className="transition-all duration-500 group-hover:translate-x-1 group-hover:-translate-y-1 origin-center"
          ...
          />
          <path 
            className="transition-all duration-600 group-hover:scale-105 origin-center"
          ...
          />
          <path 
            className="transition-all duration-700 group-hover:-translate-x-1 group-hover:-translate-y-1 origin-center"
