...
published: false
canonical_url: https://devops-daily.com/posts/neon-vs-supabase-scaling-costs
cover_image: https://devops-daily.com/images/posts/neon-vs-supabase-scaling-costs.png
tags: postgres, neon, supabase, databases
---

> Originally published on [DevOps Daily](https://devops-daily.com/posts/neon-vs-supabase-scaling-costs). The charts below are static snapshots; the live, interactive versions and the open source benchmark harness are on the original.
...
![Monthly cost of the same application as it grows](https://devops-daily.com/images/cross-posts/neon-vs-supabase-scaling-costs/chart-0-line.png)

*Monthly cost of the same application as it grows — [interactive version on DevOps Daily](https://devops-daily.com/posts/neon-vs-supabase-scaling-costs)*
...
![Where the money goes at the scale stage (Supabase Pro, $1213.39/mo total)](https://devops-daily.com/images/cross-posts/neon-vs-supabase-scaling-costs/chart-1-bar.png)

*Where the money goes at the scale stage (Supabase Pro, $1213.39/mo total) — [interactive version on DevOps Daily](https://devops-daily.com/posts/neon-vs-supabase-scaling-costs)*
