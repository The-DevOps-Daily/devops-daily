...
published: false
canonical_url: https://devops-daily.com/posts/neon-vs-supabase-operational-benchmarks
cover_image: https://devops-daily.com/images/posts/neon-vs-supabase-operational-benchmarks.png
tags: postgres, neon, supabase, databases
---

> Originally published on [DevOps Daily](https://devops-daily.com/posts/neon-vs-supabase-operational-benchmarks). The charts below are static snapshots; the live, interactive versions and the open source benchmark harness are on the original.
...
![Compute resize: API apply time vs actual SQL outage (median)](https://devops-daily.com/images/cross-posts/neon-vs-supabase-operational-benchmarks/chart-0-bar.png)

*Compute resize: API apply time vs actual SQL outage (median) — [interactive version on DevOps Daily](https://devops-daily.com/posts/neon-vs-supabase-operational-benchmarks)*
...
![Branch to queryable: Neon copies 100k rows, Supabase copies schema only](https://devops-daily.com/images/cross-posts/neon-vs-supabase-operational-benchmarks/chart-1-dots.png)

*Branch to queryable: Neon copies 100k rows, Supabase copies schema only — [interactive version on DevOps Daily](https://devops-daily.com/posts/neon-vs-supabase-operational-benchmarks)*
...
![Read replica to first query](https://devops-daily.com/images/cross-posts/neon-vs-supabase-operational-benchmarks/chart-2-dots.png)

*Read replica to first query — [interactive version on DevOps Daily](https://devops-daily.com/posts/neon-vs-supabase-operational-benchmarks)*
...
![Read replica creation as the database grows](https://devops-daily.com/images/cross-posts/neon-vs-supabase-operational-benchmarks/chart-3-line.png)

*Read replica creation as the database grows — [interactive version on DevOps Daily](https://devops-daily.com/posts/neon-vs-supabase-operational-benchmarks)*
...
![Connection stampede: N simultaneous cold connections through the pooler (median wave)](https://devops-daily.com/images/cross-posts/neon-vs-supabase-operational-benchmarks/chart-4-bar.png)

*Connection stampede: N simultaneous cold connections through the pooler (median wave) — [interactive version on DevOps Daily](https://devops-daily.com/posts/neon-vs-supabase-operational-benchmarks)*
...
![Supabase project creation to first query, free org vs Pro org](https://devops-daily.com/images/cross-posts/neon-vs-supabase-operational-benchmarks/chart-5-dots.png)

*Supabase project creation to first query, free org vs Pro org — [interactive version on DevOps Daily](https://devops-daily.com/posts/neon-vs-supabase-operational-benchmarks)*
