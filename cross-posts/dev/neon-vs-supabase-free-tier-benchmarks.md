...
published: false
canonical_url: https://devops-daily.com/posts/neon-vs-supabase-free-tier-benchmarks
cover_image: https://devops-daily.com/images/posts/neon-vs-supabase-free-tier-benchmarks.png
tags: postgres, neon, supabase, databases
---

> Originally published on [DevOps Daily](https://devops-daily.com/posts/neon-vs-supabase-free-tier-benchmarks). The charts below are static snapshots; the live, interactive versions and the open source benchmark harness are on the original.
...
![Query latency: cold connection, select 1 (median, 50 runs each)](https://devops-daily.com/images/cross-posts/neon-vs-supabase-free-tier-benchmarks/chart-0-bar.png)

*Query latency: cold connection, select 1 (median, 50 runs each) — [interactive version on DevOps Daily](https://devops-daily.com/posts/neon-vs-supabase-free-tier-benchmarks)*
...
![Query latency percentiles (50 cold connections per path)](https://devops-daily.com/images/cross-posts/neon-vs-supabase-free-tier-benchmarks/chart-1-cdf.png)

*Query latency percentiles (50 cold connections per path) — [interactive version on DevOps Daily](https://devops-daily.com/posts/neon-vs-supabase-free-tier-benchmarks)*
...
![Project creation: API call to first successful query](https://devops-daily.com/images/cross-posts/neon-vs-supabase-free-tier-benchmarks/chart-2-dots.png)

*Project creation: API call to first successful query — [interactive version on DevOps Daily](https://devops-daily.com/posts/neon-vs-supabase-free-tier-benchmarks)*
...
![Neon cold start: first query against suspended compute](https://devops-daily.com/images/cross-posts/neon-vs-supabase-free-tier-benchmarks/chart-3-dots.png)

*Neon cold start: first query against suspended compute — [interactive version on DevOps Daily](https://devops-daily.com/posts/neon-vs-supabase-free-tier-benchmarks)*
